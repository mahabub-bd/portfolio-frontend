            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-card border border-border rounded-lg hover:border-blue-500/50 hover:scale-110 transition transform"
                  aria-label="LinkedIn"
                >
                  <svg
                    className="w-6 h-6"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-card border border-border rounded-lg hover:border-blue-600/50 hover:scale-110 transition transform"
                  aria-label="Facebook"
                >
                  <svg
                    className="w-6 h-6"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 bg-card border border-border rounded-lg hover:border-green-500/50 hover:scale-110 transition transform"
                  aria-label="WhatsApp"
                >
                  <svg
                    className="w-6 h-6"
